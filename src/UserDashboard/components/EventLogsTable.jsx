                            ...
                            (filteredData
                                ...
                                .map((item, index) => (
                                    <tr key={index} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                        ...
                                        <td className="px-4 py-4 inline-flex justify-center items-center text-center gap-1">{item.event_status === "info" ? <FaCircleInfo /> : item.event_status === "warning" ? <RiErrorWarningFill className='text-yellow-500' /> : <IoIosWarning className='text-red-700' />}<span className='text-xs'>{item.event_type}</span></td>
