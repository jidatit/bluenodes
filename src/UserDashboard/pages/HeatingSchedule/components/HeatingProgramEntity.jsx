...
const HeatingProgramEntity = ({
	...
	useEffect(() => {
		fetch(
			`https://api-dev.blue-nodes.app/dev/smartheating/locations?heatingScheduleDetails=true&roomTemperature=true&assignedPrograms=true&numberOfRooms=true`,
			{
				method: "GET",
				headers: {
					Authorization: `Bearer ${token}`,
