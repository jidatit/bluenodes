      ...
      >
        ...
        <div className="flex flex-col w-full gap-4">
            ...
            <h2 className="text-[18px] text-gray-900 flex items-center gap-3">
              ...
              {activeCard && (
                <Tooltip
                  ...
                  content="Zurück zur Event Übersicht"
                  style="light"
          ...
          <div className="flex gap-4">
            ...
            >
              <div className="p-3 text-2xl text-red-700 bg-red-100 rounded-lg">
            ...
            >
              <div className="p-3 text-2xl text-green-700 bg-green-100 rounded-lg">
                <FaBuilding />
              </div>
              <div className="flex flex-col">
                <p className="font-bold text-gray-900">
                  {statsData.unassignedNumberOfRooms}/{statsData.numberOfRooms}
                </p>
                <p className="text-base font-normal text-gray-500">
                  Räume ohne Heizplan
                </p>
            ...
            >
              <div className="p-3 text-2xl text-yellow-700 bg-yellow-100 rounded-lg">
                <FaTablet />
              </div>
              <div className="flex flex-col">
                <p className="font-bold text-gray-900">
                  {statsData.numberOfDevicesOffline}/{statsData.numberOfDevices}
                </p>
                <p className="text-base font-normal text-gray-500">
                  Geräte sind offline
                </p>
...
const Card = () => {
  return (
    <div className="max-w-md px-6 pb-6 pt-4 bg-[#E7F9FD] border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
      <div className="relative flex flex-row items-end justify-start">
