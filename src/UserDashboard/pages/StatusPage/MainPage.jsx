  ...
  return (
    <>
      <div className="flex flex-col gap-6">
          ...
          <div className="w-full flex flex-col gap-4">
              ...
              <h2 className="text-[18px] text-gray-900 flex items-center gap-3">
                ...
                {activeCard && (
                  <Tooltip className="min-w-[130px]" content="Back to event Logs" style="light" animation="duration-500">
                    <h3 onClick={handleBackClick} className="text-[16px] text-primary font-normal flex items-center gap-2 cursor-pointer hover:scale-95">
            ...
            <div className="flex gap-4">
              <div
                ...
                className={`w-1/3 bg-white flex p-6 gap-4 rounded-lg shadow-sm items-center justify-start ${
                  activeCard === 'generalError' ? 'ring-primary-400 ring-2' : 'hover:ring-primary-200 hover:ring-2 cursor-pointer'
                }`}
              >
                ...
                <div className="flex flex-col">
                  ...
                  <p className="text-base text-gray-500 font-normal">Errors occurred</p>
                </div>
              </div>
              <div
                onClick={() => handleCardClick('unassignedError')}
                className={`w-1/3 bg-white flex p-6 gap-4 rounded-lg shadow-sm items-center justify-start  ${
                  activeCard === 'unassignedError' ? 'ring-primary-400 ring-2' : 'hover:ring-primary-200 hover:ring-2 cursor-pointer'
                }`}
              >
              ...
              <div
                ...
                className={`w-1/3 bg-white flex p-6 gap-4 rounded-lg shadow-sm items-center justify-start ${
                  activeCard === 'offlineError' ? 'ring-primary-400 ring-2' : 'hover:ring-primary-200 hover:ring-2 cursor-pointer'
                }`}
              >
        ...
        {!activeCard && <EventLogsTable tableData={tableData} />}
        {activeCard === 'generalError' && <ErrorLogsTable tableData={tableData} />}
        {activeCard === 'unassignedError' && <UnassignedTable tableData={tableData} />}
        {activeCard === 'offlineError' && <OfflineTable tableData={deviceData} />}
      </div>
    </>
  );
}
