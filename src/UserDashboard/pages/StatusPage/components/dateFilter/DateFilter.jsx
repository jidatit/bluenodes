			...
			<div className="relative w-full flex flex-col gap-x-2">
				<div className="flex gap-3">
					<button
						...
						className="flex justify-between text-gray-500 items-center text-[1rem] px-4 py-[0.623rem] bg-white border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
